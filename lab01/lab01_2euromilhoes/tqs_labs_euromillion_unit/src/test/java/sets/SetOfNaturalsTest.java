...
public class SetOfNaturalsTest {
    ...
    public void testSize() {
        ...
        assertTrue(setD.size() == 6, "size: contains number of elements");
    }
    ...
    public void testContains() {
        ...
        assertFalse(setA.contains(44));
    }
    
    @Test
    public void testAddNonNatural() {
        assertThrows(IllegalArgumentException.class, () -> setC.add(-55));
        assertThrows(IllegalArgumentException.class, () -> setD.add(2/3));
    }
}
